...
function Summary({ resume, setResume }) {
  ...
  const generateSummary = () => {
    const jobTitle = resume.personal?.jobTitle || "Software Developer";
    ...
    <div className="bg-[#0d0d0d] border border-white/10 rounded-2xl p-6">
      ...
      <div>
        ...
        <div className="flex justify-between mt-2">
          ...
          <p className="text-xs text-gray-500">{resume.summary.length}/800</p>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 rounded-xl bg-violet-500/5 border border-violet-500/10">
        <div className="flex gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white">Resume Tip</h3>

            <p className="text-sm text-gray-500 mt-1 leading-6">
              Highlight your experience, strongest skills, achievements, and the
              type of role you are targeting. Avoid generic statements.
            </p>
          </div>
        </div>
      </div>
