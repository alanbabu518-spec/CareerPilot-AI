    ...
    <div className="bg-[#0d0d0d] border border-white/10 rounded-2xl p-6">
      ...
      {resume.education.length === 0 && (
        <div className="border border-dashed border-white/10 rounded-xl p-10 text-center">
          <GraduationCap size={40} className="mx-auto text-gray-600" />

          <h3 className="text-white font-semibold mt-4">No education added</h3>

          <p className="text-gray-500 text-sm mt-2">
            Add your degree, college, school, or other educational
            qualifications.
          </p>
        ...
        {resume.education.map((item, index) => (
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div>
                <label className="resume-label">Degree / Qualification</label>
              ...
              <div>
                <label className="resume-label">Grade / CGPA</label>
