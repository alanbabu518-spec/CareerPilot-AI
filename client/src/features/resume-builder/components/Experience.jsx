        ...
        item.id === experienceId
          ? {
              ...
              responsibilities: item.responsibilities.map(
                (responsibility, i) => (i === index ? value : responsibility),
              ),
            }
          : item,
      ),
    ...
    <div className="bg-[#0d0d0d] border border-white/10 rounded-2xl p-6">
      ...
      {resume.experience.length === 0 && (
        <div className="border border-dashed border-white/10 rounded-xl p-10 text-center">
          ...
          <h3 className="text-white font-semibold mt-4">No experience added</h3>

          <p className="text-gray-500 text-sm mt-2">
            Add your jobs, internships, freelance work, or other professional
            experience.
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  value={item.jobTitle}
                  onChange={(e) =>
                    updateExperience(item.id, "jobTitle", e.target.value)
                  }
                    ...
                    <div key={responsibilityIndex} className="flex gap-2">
                      ...
                      {item.responsibilities.length > 1 && (
                        <button
                          type="button"
                          onClick={() =>
                            removeResponsibility(item.id, responsibilityIndex)
                          }
