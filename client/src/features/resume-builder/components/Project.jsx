...
function Projects({ resume, setResume }) {
  ...
  const removeTechnology = (projectId, technology) => {
    setResume((prev) => ({
      ...prev,
      projects: prev.projects.map((project) =>
        project.id === projectId
    ...
    setResume((prev) => ({
      ...
      projects: prev.projects.map((project) =>
        project.id === projectId
          ? {
              ...project,
              achievements: project.achievements.map((achievement, i) =>
    ...
    <div className="bg-[#0d0d0d] border border-white/10 rounded-2xl p-6">
      ...
      {resume.projects.length === 0 && (
        <div className="border border-dashed border-white/10 rounded-xl p-10 text-center">
          <FolderGit2 size={40} className="mx-auto text-gray-600" />

          <h3 className="text-white font-semibold mt-4">No projects added</h3>
        ...
        {resume.projects.map((project, index) => (
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div>
                <label className="resume-label">Your Role</label>
              ...
              <div>
                <label className="resume-label">Live Demo URL</label>
              ...
              <div>
                <label className="resume-label">GitHub URL</label>
            ...
            <div className="mt-5">
              <label className="resume-label">Project Description</label>
            ...
            <div className="mt-5">
              <label className="resume-label">Technologies</label>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {project.technologies.map((technology) => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => removeTechnology(project.id, technology)}
                      >
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between mb-3">
                <label className="resume-label mb-0">Key Contributions</label>
                  ...
                  <div key={achievementIndex} className="flex gap-2">
                    ...
                    {project.achievements.length > 1 && (
                      <button
                        type="button"
                        onClick={() =>
                          removeAchievement(project.id, achievementIndex)
                        }
