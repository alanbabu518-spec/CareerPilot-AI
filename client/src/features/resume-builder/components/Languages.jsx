    ...
    <div className="bg-[#0d0d0d] border border-white/10 rounded-2xl p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-violet-600/15 flex items-center justify-center">
            <LanguagesIcon size={20} className="text-violet-400" />
          </div>
      ...
      {resume.languages.length === 0 && (
        <div className="border border-dashed border-white/10 rounded-xl p-10 text-center">
          <LanguagesIcon size={40} className="mx-auto text-gray-600" />

          <h3 className="text-white font-semibold mt-4">No languages added</h3>
        ...
        {resume.languages.map((language, index) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-white font-semibold">Language {index + 1}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div>
                <label className="resume-label">Language</label>
              ...
              <div>
                <label className="resume-label">Proficiency</label>
                ...
                >
                  {proficiencyLevels.map((level) => (
                    <option key={level} value={level} className="bg-[#151515]">
                      {level}
                    </option>
                  ))}
                </select>
